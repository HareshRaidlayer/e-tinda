			...
			<table class="padding text-left small border-bottom">
				<thead>
	                <tr class="gry-color" style="background: #eceff4;">
	                    ...
	                    <th width="15%">{{ translate('Service Price') }}</th>
				...
				<tbody class="strong">
		                ...
		                @if ($service != null)
							<tr class="">
								<td>{{ $service->name }}</td>
								<td>{{ translate('Home Delivery') }}</td>
								<td class="gry-color">1</td>
								<td class="gry-color currency">{{ single_price($service->price) }}</td>
								<td class="gry-color currency">{{ single_price(0) }}</td>
