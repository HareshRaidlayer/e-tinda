			...
			<table class="padding text-left small border-bottom">
				<thead>
	                <tr class="gry-color" style="background: #eceff4;">
	                    <th width="35%" class="text-left">{{ translate('Service Name') }}</th>
						<th width="15%" class="text-left">{{ translate('Delivery Type') }}</th>
	                    <th width="10%" class="text-left">{{ translate('Payment Status') }}</th>
				...
				<tbody class="strong">
                    ...
                    <tr class="">
                        ...
                        <td class="currency">{{ single_price($service->price) }}</td>
