...
<head>
    ...
    <link rel="stylesheet" href="{{ static_asset('assets/css/shopee.css') }}">
...
.sub-mrnu-custom:hover{
            background:rgba(19,129,76,0.15);;
        }
    </style>
...
<body>
    ...
    <div class="aiz-main-wrapper d-flex flex-column">
        ...
        @endphp
        <!-- Header -->
        @include('frontend.incShopee.nav')

        @yield('content')

        <!-- footer -->
        @include('frontend.incShopee.footer')

    </div>

    <!-- Floating Buttons -->
    @include('frontend.incShopee.floating_buttons')
    ...
    <script>
        ...
        function addToCartService(){
            ...
            if(checkAddToCartValidity()) {
                ...
                $.ajax({
                    type:"POST",
                    url: '{{ route('cart.addtocartService') }}',
                    data: $('#option-choice-form').serializeArray(),
                    success: function(data){
                       $('#addToCart-modal-body').html(null);
                       $('.c-preloader').hide();
