...
@section('content')
    ...
    <!-- Sliders -->
    <div class="home-banner-area mb-3 mt-0 mt-md-4" style="">
        <div class="container">
                                        ...
                                        <div class="carousel-box overflow-hidden hov-scale-img">
                                            <a href="{{ isset(json_decode($home_banner1_links, true)[$key]) ? json_decode($home_banner1_links, true)[$key] : '' }}"
                                                ...
                                                <img src="{{ static_asset('assets/img/placeholder-rect.jpg') }}"
                                                    ...
                                                    alt="{{ env('APP_NAME') }} promo"
                                                    class="img-fluid-custom lazyload w-100 has-transition"
                                                    onerror="this.onerror=null;this.src='{{ static_asset('assets/img/placeholder-rect.jpg') }}';">
                                            </a>
                                        </div>
                                    @endforeach
    ...
    @if (count($featured_categories) > 0)
        <section class="mb-1 mb-md-2 pt-1 pt-md-0.5rem featured-categories">
            <div class="container">
                <div class="card">
                                ...
                                <div class="carousel-box px-4 d-flex flex-column align-items-center py-2">
                                    <div class="size-80px overflow-hidden hov-scale-img">
                                        <a class="d-block" href="{{$service_url}}">
                                            <img src="{{ isset($services['thumbnail_img']) ? my_asset($services['thumbnail_img']) : static_asset('assets/img/placeholder.jpg') }}"
                                            class="lazyload img-fit h-100 mx-auto has-transition"
                                            alt="{{ $category->getTranslation('name') }}"
                                            onerror="this.onerror=null;this.src='{{ static_asset('assets/img/placeholder.jpg') }}';">
                                        </a>
    ...
    @endphp
    @if ($flash_deal != null)
        <section class="mb-2 mb-md-3" id="flash_deal">
            <div class="container">
                <div class="card p-3">
                <!-- Top Section -->
                <div class="d-flex flex-wrap mb-2 mb-md-3 align-items-baseline justify-content-between">
                    ...
                    <div class="d-flex align-items-center">
                        <h3 class="fs-16 fs-md-20 fw-700 mb-2 mb-sm-0 text-primary">
                    ...
                    <div>
                        <div class="text-dark d-flex align-items-center mb-0">
                            <a href="{{ route('flash-deals') }}"
                                class="fs-10 fs-md-12 fw-700 text-primary has-transition  hov-opacity-100 hov-text-primary animate-underline-primary mr-3">{{ translate('View All Flash Sale') }}</a>
                            <span class=" border-left border-soft-light border-width-2 pl-3">
                                <a href="{{ route('flash-deal-details', $flash_deal->slug) }}"
                                    class="fs-10 fs-md-12 fw-700 text-primary has-transition  hov-opacity-100 hov-text-primary animate-underline-primary">{{ translate('View All Products from This Flash Sale') }}</a>
                            </span>
                        </div>
                    </div>
                </div>
                ...
                <div class="row gutters-5 gutters-md-16">
                    ...
                    <div class="col-xxl-12 col-lg-12 col-12">
                        ...
                        <div class="aiz-carousel border-top @if (count($flash_deal_products) > 8) border-right @endif arrow-inactive-none arrow-x-0"
                            data-items="6" data-xxl-items="6" data-xl-items="6" data-lg-items="5" data-md-items="4"
                            data-sm-items="3" data-xs-items="2" data-arrows="true" data-dots="false"
                                    ...
                                    @if ($flash_deal_product->product != null && $flash_deal_product->product->published != 0)
                                        ...
                                        <div
                                            ...
                                            <a href="{{ $product_url }}"
                                                ...
                                                <div class="flesh-deal-discount-shopee">
                                                    <svg xmlns="http://www.w3.org/2000/svg" width="11" height="18"
                                                        viewBox="0 0 16 24" class="ml-3">
                                                        <path id="Path_28795" data-name="Path 28795"
                                                            d="M30.953,13.695a.474.474,0,0,0-.424-.25h-4.9l3.917-7.81a.423.423,0,0,0-.028-.428.477.477,0,0,0-.4-.207H21.588a.473.473,0,0,0-.429.263L15.041,18.151a.423.423,0,0,0,.034.423.478.478,0,0,0,.4.2h4.593l-2.229,9.683a.438.438,0,0,0,.259.5.489.489,0,0,0,.571-.127L30.9,14.164a.425.425,0,0,0,.054-.469Z"
                                                            transform="translate(-15 -5)" fill="#e62e04"></path>
                                                    </svg>
                                                    - {{ $flash_deal_product->product->discount }}
                                                    @if ($flash_deal_product->product->discount_type == 'amount')
                                                        {{ translate('Flat') }}
                                                    @else
                                                        @php
                                                            echo '%';
                                                ...
                                                <div class="d-flex justify-content-center">
                                                    <div class="shopee-sellinf-fast"> {{ translate('Selling Fast') }}
                                                    </div>
                                                </div>
                                            </a>
                                        </div>
    ...
    <!-- Today's deal -->
    <div id="todays_deal" class="mb-2 mb-md-3 mt-1 mt-md-0">
            ...
            <section class="mb-2 mb-md-3 mt-2 mt-md-3">
                <div class="container">
                    ...
                    <div class="d-flex mb-2 mb-md-3 align-items-baseline justify-content-between">
                        <!-- Title -->
                        <h3 class="fs-16 fs-md-20 fw-700 mb-2 mb-sm-0">
                            <span class="pb-3 text-primary">{{ translate('Top Sellers') }}</span>
                        </h3>
                        <!-- Links -->
                        <div class="d-flex">
                            <a class="text-primary fs-10 fs-md-12 fw-700 hov-text-primary animate-underline-primary"
                    ...
                    <div class="aiz-carousel arrow-x-0 arrow-inactive-none" data-items="5" data-xxl-items="5"
                        ...
                        @foreach ($best_selers as $key => $seller)
                            @if ($seller->user != null)
                                <div
                                    class="carousel-box bg-white h-100 position-relative text-center border-right border-top border-bottom @if ($key == 0) border-left @endif has-transition hov-animate-outline">
    ...
    <div class="container mt-4">
        <h6 class="text-reset fs-16 fs-md-20 fw-700 mb-3">{{ translate('categories') }}</h6>
        <div class="row">
            @foreach ($categories as $key => $category)
                <div class="col-6 col-md-3">
                    <a href="{{ route('products.category', $category->slug) }}"
                        class="text-reset fs-15 fs-md-18 fw-600 hov-text-primary text-uppercase">
                    ...
                    <div class="col-4 text-left mb-1">
                        ...
                        <h6 class="text-dark mb-3">
                            <a class="text-reset fw-400 fs-13 hov-text-primary"
