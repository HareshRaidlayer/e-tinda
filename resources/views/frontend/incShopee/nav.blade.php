    ...
    <header class="@if (get_setting('header_stikcy') == 'on') sticky-top @endif z-1020 bg-primary">
        <!-- Search Bar -->
        <div class="position-relative logo-bar-area border-md-nonea z-1025">
            <div class="container">
                ...
                <div class="d-flex align-items-center">
                    ...
                    <div class="flex-grow-1 front-header-search d-flex align-items-center bg-white mx-xl-5">
                        <div class="position-relative flex-grow-1 px-0 px-lg-0">
                    ...
                    <!-- Search box -->
                    <div class="d-none d-xl-block align-self-stretch mr-0 has-transition h-50px" data-hover="dropdown">
                        <div class="nav-cart-box dropdown h-50px" id="cart_items" style="width: max-content;">
                        ...
                        @else
                            ...
                            <span class="d-flex align-items-center nav-user-info ml-3">
                                ...
                                <a href="{{ route('user.login') }}"
                                    class="text-white  hov-opacity-100  fs-12 d-inline-block border-right border-soft-light border-width-2 pr-2 ml-3">{{ translate('Login') }}</a>
                                <a href="{{ route('user.registration') }}"
                                    class="text-white  hov-opacity-100  fs-12 d-inline-block py-2 pl-2">{{ translate('Registration') }}</a>
                            </span>
                        @endauth
                    </div>
                </div>
            ...
            <div class="hover-user-top-menu position-absolute top-100 left-0 right-0 z-3">
                <div class="container">
                    <div class="position-static-custom float-right">
                ...
                <div class="d-flex h-100">
                    ...
                    <div class="d-none d-xl-block all-category has-transition " id="category-menu-bar">
                        <div class="px-3 h-100"
                            style="padding-top: 12px;padding-bottom: 12px; width:200px; cursor: pointer;">
        ...
        <div class="collapse-sidebar c-scrollbar-light text-left">
            ...
            @else
                ...
                <span class="d-flex align-items-center nav-user-info pl-4">
                    ...
                    <a href="{{ route('user.login') }}"
                        class="text-primary  hov-opacity-100 hov-text-primary fs-12 d-inline-block border-right border-soft-light border-width-2 pr-2 ml-3">{{ translate('Login') }}</a>
                    <a href="{{ route('user.registration') }}"
                        class="text-primary  hov-opacity-100 hov-text-primary fs-12 d-inline-block py-2 pl-2">{{ translate('Registration') }}</a>
                </span>
            @endauth
            <hr>
