<div class="modal-body px-4 py-5 c-scrollbar-light">
                    ...
                    <div class="aiz-card-box my-2 has-transition">
                        ...
                        <div class="p-md-3 p-2 text-center">
                            <h3 class="fw-400 fs-14 text-dark text-truncate-2 lh-1-4 mb-0 h-35px">
                                <a href="" class="d-block text-reset hov-text-primary">{{ $related_product->name }}</a>
                            </h3>
    ...
    <div class="row gutters-5">
        ...
        <div class="col-sm-6">
            <a href="{{ route('cartService') }}" class="btn btn-primary mb-3 mb-sm-0 btn-block rounded-0">{{ translate('Proceed to Checkout')}}</a>
        </div>
