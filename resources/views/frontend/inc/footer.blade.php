...
<section class="py-3 text-light footer-widget border-bottom" style="border-color: #fff !important; background-color: #fff !important;">
    <div class="container">
        <!-- footer logo -->
        ...
        <div class="row">
            ...
            <div class="col-xl-6 col-lg-7">
                ...
                <h5 class="fs-14 fw-700 text-primary mt-1 mb-3">{{ translate('Subscribe to our newsletter for regular updates about Offers, Coupons & more') }}</h5>
                <div class="mb-3">
        ...
        <div class="row">
                ...
                <div class="text-center text-sm-left mt-4">
                    ...
                    <ul class="list-unstyled">
                        <li class="mb-2">
                            ...
                            <p  class="fs-13 text-secondary">{{ get_setting('contact_address',null,App::getLocale()) }}</p>
                        </li>
                        <li class="mb-2">
                            <p  class="fs-13 text-secondary mb-1">{{ translate('Phone') }}</p>
                            <p  class="fs-13 text-secondary">{{ get_setting('contact_phone') }}</p>
                        </li>
                        <li class="mb-2">
                            <p  class="fs-13 text-secondary mb-1">{{ translate('Email') }}</p>
                            <p  class="">
                                <a href="mailto:{{ get_setting('contact_email') }}" class="fs-13 text-secondary hov-text-primary">{{ get_setting('contact_email')  }}</a>
                            </p>
                        </li>
                    </ul>
                </div>
            ...
            <div class="col-lg-3 col-md-4 col-sm-6">
                <div class="text-center text-sm-left mt-4">
                    ...
                    <h5 class="fs-14 fw-700 text-dark text-uppercase mt-3 mt-lg-0">{{ translate('Follow Us') }}</h5>
                    <ul class="list-inline social colored mb-4">
                        @if (!empty(get_setting('facebook_link')))
                            <li class="list-inline-item ml-2 mr-2 mb-1">
                ...
                <h5 class="fs-14 fw-700 text-dark text-uppercase mt-3">{{ translate('Mobile Apps') }}</h5>
                <div class=" mt-3 mb-3">
                    <div class="">
            ...
            @endif
                    ...
                    @if (addon_is_activated('delivery_boy'))
                        <h4 class="fs-14 text-dark text-uppercase fw-700 mt-4 mb-3">{{ translate('Delivery Boy') }}</h4>
                        <ul class="list-unstyled">
                            @guest
                                <li class="mb-2">
...
<!-- FOOTER -->
<footer class="pt-3 pb-7 pb-xl-3 bg-white text-soft-light border-xl-top">
    <div class="container">
        <div class="row align-items-center py-3">
            <!-- Copyright -->
            <div class="col-lg-6 order-1 order-lg-0">
                <div class="text-center text-secondary fs-14" current-verison="{{get_setting("current_version")}}">
