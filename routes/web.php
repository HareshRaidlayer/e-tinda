...
Route::controller(CartController::class)->group(function () {
    ...
    Route::get('/cart-service', 'indexService')->name('cartService');
    ...
    Route::post('/cart/addtocartService', 'addToCartService')->name('cart.addtocartService');
});
...
Route::group(['prefix' => 'checkout'], function () {
    Route::controller(CheckoutController::class)->group(function () {
        ...
        Route::get('/service', 'service')->name('checkoutService');
        ...
        Route::get('/payment/callback/walute', [WalletController::class, 'handleCallbackValute'])->name('payment.callbackValue');
    });
});
